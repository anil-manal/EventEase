...
const Login = () => {
    const [loginFn, { isSuccess, isError }] = useLoginMutation()
    ...
    return (
        ...
        >
            <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                <div className="hidden lg:block lg:w-1/2 bg-cover" style={{ backgroundImage: "url('https://img.freepik.com/free-vector/tablet-login-concept-illustration_114360-7883.jpg?w=740&t=st=1704735884~exp=1704736484~hmac=18a436c54435f087e490436bdb924aa79760feda151ce2977a65a83486c65fac')" }}></div>
                <motion.div className="w-full p-8 lg:w-1/2" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                    ...
                    <motion.div className="mt-4">
                        ...
                        <motion.input
                            ...
                            name='password'
                        />
                        <motion.a href="#" className="text-xs text-gray-500" whileHover={{ scale: 1.1 }}>
                            Forget Password?
                        </motion.a>
                    </motion.div>
